...
ml display
	if "`xs'"=="ib1.events" {
		estimates store ev_`rstory'_`tstory'
	}
	else if "`xs'"=="i.wave" {
		estimates store wv_`rstory'_`tstory'
		}
	}
 }
}
...
estimates restore wv_linear_Expo
	...
	erepost b=b V=V
ml display
estimates store wv_linear_Expo
...
estimates restore wv_linear_Hyper
	...
	erepost b=b V=V
ml display
estimates store wv_linear_Hyper
...
estimates restore ev_linear_Expo
	...
	erepost b=b V=V
ml display
estimates store ev_linear_Expo
...
estimates restore ev_linear_Hyper
	...
	erepost b=b V=V
ml display
estimates store ev_linear_Hyper
...
estimates restore wv_gprelec_Expo
	...
	erepost b=b V=V
ml display
estimates store wv_gprelec_Expo
...
estimates restore wv_gprelec_Hyper
	...
	erepost b=b V=V
ml display
estimates store wv_gprelec_Hyper
...
estimates restore ev_gprelec_Expo
	...
	erepost b=b V=V
ml display
estimates store ev_gprelec_Expo
...
estimates restore ev_gprelec_Hyper
	...
	erepost b=b V=V
ml display
estimates store ev_gprelec_Hyper	