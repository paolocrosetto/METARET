############## Description of dta_2019_raw.xlsx ###############################

June 4, 2022.

File dta_2019_raw.xlsx contains raw data (encoded from paper) for Experiment II
of Battiston & al (2021).

Notice that subjects indexed (variable "index") from 312 to 326 were excluded
from the analysis as explained in the paper (Appendix C).

IDENTIFYING VARIABLES:
----------------------

- "sessione": session date
- "Treat": treatment (Blue, Yellow or Within): combined with "sessione",
  actually identifies session
- "totem": individual identifier (unique within session)
- "gruppo": (minimal) group (enumerated within session)
