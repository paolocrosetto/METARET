function plot_Figure_IX
%%%%%%Note: this program produces Figure IX in Frydman and Jin (2021)
...
n = 12;           %capacity constraint parameter (high vol condition)
...
n = 7;             %capacity constraint parameter (low vol condition)
