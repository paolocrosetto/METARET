...
J'ai également essayé de contribuer à résoudre le problème de la faible validité externe entre RETs et les questionnaires sur la base des données collectées. L'approche pour cette partie de ma mission est décrite dans la partie 4 de ce rapport.
...
```
\newpage
Tableau 8 - La liste de préférences pour les RETs selon écart avec SOEP et DOSPERT.
