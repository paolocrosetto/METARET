...
date: "FAST Meeting -- Rennes -- September 2021"
output:
...
- despite experimental & empirical efforts, there are problems with the very concept of risk attitudes
- *efforts and advances in this very WP!*
...
- **noise** (ex post, but also ex-ante through iteration)
- **cognitive abilities** (from as early as the design phase)
- **risk perception** (crucial overlooked variable in standard tasks)
- **revisits what is risk** for the practitioners and for the theory
