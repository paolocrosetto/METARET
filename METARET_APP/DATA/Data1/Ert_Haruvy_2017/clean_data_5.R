...
#### getting the data
df <- readxl::read_excel("Data1/Ert_Haruvy_2017/EyalCombined.xlsx") %>% as_factor()
...
# Writing to file
df %>% write_csv("Data1/Ert_Haruvy_2017/formatted_dataset.csv")
