...
#### getting the data
df <- read_dta("DATA/Data/Crosetto_Filippin_Experimental_Economics_2016/original_dataset.dta") %>% as_factor()
...
# Writing to file
df %>% write_csv("DATA/Data/Crosetto_Filippin_Experimental_Economics_2016/formatted_dataset.csv")
