...
- an **OSF page** [(here)](https://osf.io/h2z56/) where the project is being pre-registered;
...
- *dynamically explorable*, on the [shiny app](https://paolocrosetto.shinyapps.io/METARET/). 
...
METARET will be **developed in public**. As new papers and data sources arrive, they will be added to the repository, cleaned, correlations will be computed, and results will be fed to the [shiny app](https://paolocrosetto.shinyapps.io/METARET/). You will be able to **track** the active development of the meta-analysis. 

### Presentation

The methodology and first results of METARET will be the object of a special [semi-pleanry session](https://lessac.bsb-education.com/index.php?page=plenary) organized by me at the [2019 Dijon European ESA meeting](https://lessac.bsb-education.com/index.php?page=european-esa-meeting-dijon-sept-2019). Pop by Dijon to learn more. 
...
The plots and analyses are updated for each new contributed paper. An interactive version fo the same data is to be found at the [shiny app](https://paolocrosetto.shinyapps.io/METARET/)
